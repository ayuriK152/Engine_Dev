...
void FileIOManager::Init()
{
	LoadTextures();
	LoadMaterials();
}

void FileIOManager::XMLFromMaterial(shared_ptr<Material> material, const wstring& name)
{
...
void FileIOManager::LoadTextures()
{
...
void FileIOManager::LoadMaterials()
{
	tinyxml2::XMLDocument doc;
