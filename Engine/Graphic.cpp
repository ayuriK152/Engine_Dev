...
HINSTANCE Graphic::AppInst()const
{
	return mhAppInst;
}

HWND Graphic::MainWnd()const
{
	return mhMainWnd;
}

float Graphic::AspectRatio()const
{
...
void Graphic::SetAppInst(HINSTANCE hInstance)
{
	mhAppInst = hInstance;
}
...
void Graphic::Update(const GameTimer& gt)
{

}

void Graphic::Draw(const GameTimer& gt)
{
